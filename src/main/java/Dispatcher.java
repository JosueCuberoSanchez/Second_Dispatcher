...
public class Dispatcher {
    ...
    public Dispatcher(){
        ...
        this.ipTableSilvia.put("12.0.0.0",new IpData("127.0.0.1", "12.0.0.8", "165.8.6.25", 0,8888));//banderas
        this.ipTableSilvia.put("200.5.0.0",new IpData("192.168.100.16", "200.5.0.2", "165.8.6.25",1,0));//paletas
        this.ipTableSilvia.put("140.90.0.0",new IpData("192.168.100.16", "12.0.0.8", "165.8.6.25", 2,0));//bolinchas
        this.ipTableSilvia.put("201.6.0.0",new IpData("192.168.100.16", "12.0.0.8", "165.8.6.25", 2,0));//legos
        this.ipTableSilvia.put("25.0.0.0",new IpData("192.168.100.16", "12.0.0.8", "165.8.6.25", 1,5555));//luces
